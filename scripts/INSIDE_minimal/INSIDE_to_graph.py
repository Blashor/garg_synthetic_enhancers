...
def score_by_gen(gen_holder, output):
    ...
    for rep in gen_holder:
        print(rep)
        sns.lineplot(
            x=range(len(gen_holder[rep])),
            y=np.sqrt(gen_holder[rep] / 3),
            alpha=0.8,
            label=rep,
        )
    plt.savefig(output)
...
# calc_gc(gen_holder)
# score_by_gen(gen_holder, "../figures/3b_cluster1.svg")

# gen_holder = main("../data/INSIDE_graded_on4_3model.txt")
# score_by_gen(gen_holder, "../figures/3b_nocluster.svg")

examples = [
    "/Users/blake/Documents/gargLab/INSIDE/INSIDE_center.txt",
    "/Users/blake/Documents/gargLab/INSIDE/INSIDE_margin.txt",
    "/Users/blake/Documents/gargLab/INSIDE/INSIDE_len.txt",
    "/Users/blake/Documents/gargLab/INSIDE/INSIDE_muts.txt",
]
"""
examples = [
    "/Users/blake/Downloads/INSIDE_genomeA.out",
    "/Users/blake/Downloads/INSIDE_genomeB.out",
    "/Users/blake/Downloads/INSIDE_genomeC.out",
]
"""
...
for example in examples:
    ...
    score_by_gen(gen_holder, f"/Users/blake/Downloads/a{name}")
