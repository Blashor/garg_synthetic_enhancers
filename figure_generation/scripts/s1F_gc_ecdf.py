...
def calculate_gc_dist(file_name):
    fasta = Fasta("../data/GRCm38.primary_assembly.genome.fa")
    gc_dist = []
...
"""
os.system(
    f"bedtools shuffle -i ../data/3runs-FDR-FIRE-peaks.bed -g ../data/GRCm38.primary_assembly.genome.fa.fai > ../data/Fire_shuffle.bed"
)
"""
...
gc_dist = calculate_gc_dist("../data/SRX10040677_dnase.05.bed")
sns.ecdfplot(data=gc_dist, label=f"DNAseI, Median: {round(np.median(gc_dist),3)}")
gc_dist = calculate_gc_dist("../data/SRX23682289_atac2.05.bed")
