...
def calculate_cutoff(
    inputVector, drawPlot=True, return_y_thresh=False, savePlot="", drawTangent=True, figsize=(2.5, 2.5)
):
...
def main(fp="../data/cluster_rank.txt", save="../figures/clusters_ranked.svg", tangent=False, figsize=(2.5, 2.5)):
    odds_ratios = []
    ...
    y_cutoff = calculate_cutoff(
        odds_ratios, drawPlot=True, return_y_thresh=True, savePlot=save, drawTangent=tangent, figsize=figsize
    )


# 1c
main(fp="../data/3runs_ce_rank.txt", save="../figures/1c_3runs_ce_rank.svg", figsize=(4, 2.5))
# 1e
main(fp="../data/GM12878_ce_rank.txt", save="../figures/1e_GM12878_ce_rank.svg", figsize=(2.5, 2.0))
# 1f
main(fp="../data/K562_ce_rank.txt", save="../figures/1f_K562_ce_rank.svg", figsize=(4.0, 3.0))
# s2c
main(fp="../data/3runs_ce_rank.txt", save="../figures/s2c_3runs_ce_rank_tangent.svg", tangent=True, figsize=(3.0, 3.0))
