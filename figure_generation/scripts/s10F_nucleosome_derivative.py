...
for ce_mode in range(2):
    ...
    # ax.bar(bin_centers, ratio, width=bin_width, align="center", alpha=0.4)
    ...
    #    ax.axvline(i * 147, linestyle="--")
    if ce_mode == 0:
        plt.plot(bin_centers, dratio_dx, linewidth=2, label="HCOE")
    if ce_mode == 1:
        plt.plot(bin_centers, dratio_dx, linewidth=2, label="CE")
    plt.xlabel("Nucleosome Occupancy (bp)")
