...
sns.ecdfplot(data=control_dist, label="Control", alpha=0.8)
sns.ecdfplot(data=samples, label="Normal Distribution", alpha=0.5)
sns.ecdfplot(data=snp_dist, label="SNV", alpha=0.8)
plt.xlim([-512, 512])
plt.ylim([0, 1.1])
plt.legend()
