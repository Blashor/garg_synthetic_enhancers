...
def main():
    ...
    matName = "../data/3runs_2_merge.gz"
    heatFile = "../figures/fire_3runs_BOX.svg"
    ...
    bws = "../data/SRX027332.bw ../data/SRX000540.bw ../data/SRX000583.bw ../data/SRX022695.bw ../data/SRX143842.bw"
    # scale-regions
